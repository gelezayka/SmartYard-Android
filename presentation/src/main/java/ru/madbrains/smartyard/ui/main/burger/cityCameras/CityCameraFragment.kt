...
class CityCameraFragment : Fragment(), ExitFullscreenListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnCityCameraRequestRecord.setOnClickListener {
            this.findNavController()
                .navigate(R.id.action_cityCameraFragment_to_requestRecordFragment)
        }
    ...
    private fun setupEventAdapter() {
        ...
        val adapter =
            CityCameraEventAdapter(viewModel.eventList, CityCamerasViewModel.CHUNK_ITEM_COUNT) {
                val youtubeIntent =
                    Intent(Intent.ACTION_VIEW, Uri.parse(viewModel.eventList[it].url))
                try {
            ...
            override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
                ...
                if (i2 == viewModel.eventList.size - 1 && i1 > 0) {
                    ...
                    binding.tvCityCameraScroll.text =
                        resources.getString(R.string.city_camera_scroll_up)
